...
var param = {
  ...
  requestData(function(res){
    if(res.success == true){
      ...
      console.log(items);
    $.each(items,function (index,domEle){
        var strhtml ='<li style="border: 1px solid #5aa0e3;padding: 10px;margin-bottom: 10px;" class="clear">'
              +'<div class="fl" style="margin-right: 10px;"><img class="jqimg" style="width: 120px;height: 80px;" src=""></img></div>'
              +'<div class="clear">'
     ...
     $("#propertyNews").html(strhtml);
      $(".jqimg").attr("src", items[index].image);
    });
  }
  },param,urlA+"product");
});
...
var param = {
  ...
  requestData(function(res){
    if(res.success == true){
      ...
      console.log(items);
    $.each(items,function (index,domEle){
        var strhtml ='<img class="proimg" style="border-radius: 50%;width: 120px;height: 120px;"></img>'
